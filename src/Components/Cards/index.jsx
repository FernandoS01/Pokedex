export function Cards(props) {
  return (
    <div className="flex flex-col items-center bg-yellow-600 w-1/4 border border-black rounded-lg overflow-hidden shadow-md gap-3 py-4 shadow-black text-center">
